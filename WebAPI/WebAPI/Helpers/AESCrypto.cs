...
namespace WebAPI.Helpers
{
    ...
    {
        // * No se pueden declarar miembros de una instancia en una clase estática, por lo tanto se agregó 'static' *
        // * Por convención de nomenclatura el nombre debería comenzar con un caracter en mayúscula *
