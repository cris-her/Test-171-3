...
namespace WebAPI.Models
{
    ...
    public class urlClass
    {
        ...
        public string canal;  //Valor fijo, debe ser W.
        ...
        public string fh_vigencia;  //Si este elemento se recibe con el valor 1 , se solicitará la captura del correo electrónico en el formulario de pago.
        ...
        public List<data> datos_adicionales;  //Si este elemento está presente, se incluirán los elementos hijos data en el formulario de pago y serán devueltos en la respuesta del resultado de un cobro. Si se especifica el atributo “display” con el booleano true , estos se mostrarán en el formulario de pago.
